...
{
  "questions": [{
    "question": "프롬프트를 강화했습니다. 강화된 버전을 확인해주세요.",
    "header": "✨ 프롬프트 강화",
    "options": [
      { "label": "강화 버전으로 진행 (Recommended)", "description": "위 강화된 프롬프트로 파이프라인을 시작합니다." },
      { "label": "직접 수정", "description": "수정할 내용을 입력하면 반영하여 재생성합니다." },
      { "label": "원본으로 진행", "description": "원본 프롬프트 그대로 파이프라인을 시작합니다." },
